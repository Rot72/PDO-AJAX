$(document).ready(function() {
  ...
  $('#formContainerAddUser, #formContainerEditUser').on('input change', "input[name='first_name'], input[name='last_name'], input[name='email'], .country-select, input[name='gender']", function() {
    console.log('Input or change event detected'); // Log to check event detection
    checkFields();
  });
