...
function renderAddUserForm() {
    ...
    console.log('addUserFormHtml: ' + addUserFormHtml);
}


$('#offcanvasoffcanvasAddUserEditUser').on('shown.bs.offcanvas', function () {
...
function renderEditUserForm(userData) {
    ...
    console.log('editUserFormHtml: ' + editUserFormHtml);
}
