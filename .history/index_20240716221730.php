...
<body>
  ...
  <!-- Offcanvas containers -->
  <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasAddUser" aria-labelledby="offcanvasAddUserLabel">
    <div class="offcanvas-header">
      <h5 class="offcanvas-title" id="offcanvasAddUserLabel">Add New User</h5>
      <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body">
      <!-- Form container -->
      <div id="formContainerAddUser"></div>
    </div>
  </div>



  <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasEditUser" aria-labelledby="offcanvasEditUserLabel">
    <div class="offcanvas-header">
      <h5 class="offcanvas-title" id="offcanvasEditUserLabel">Edit User</h5>
      <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body">
      <!-- Form container -->
      <div id="formContainerEditUser"></div>
    </div>
  </div>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" style="width:600px;">
    ...
    <div class="offcanvas-body">
      <form method="POST" id="insertForm">
        ...
        <div>
          <button type="submit" class="btn btn-primary me-1" id="insertBtn" disabled>Submit</button>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEditUser" style="width:600px;">
    ...
    <div class="offcanvas-body">
      <form method="POST" id="editForm">
        ...
        <div>
          <button type="submit" class="btn btn-primary me-1" id="editBtn" disabled>Update</button>
          <button type="button" class="btn btn-secondary" data-bs-dismiss="offcanvas">Cancel</button>
        </div>
      </form>
    </div>
