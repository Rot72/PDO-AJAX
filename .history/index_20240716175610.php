      ...
      <form method="POST" id="insertForm">
        <div class="row mb-3">
          <div class="col">
            ...
            <input type="text" class="form-control first_name" name="first_name" placeholder="Nikola">
          </div>
          <div class="col">
            <label class="form-label">Last Name</label>
            <input type="text" class="form-control last_name" name="last_name" placeholder="Tesla">
          </div>
        </div>
        <div class="mb-3">
        ...
        <div class="row mb-3">
          ...
          <div class="col-2">
            <img class="preview_img" src="uploads/default_profile.jpg">
          </div>
          <div class="col-10">
