$(document).ready(function() {
    ...
    $("#editForm input[name='first_name'], #editForm input[name='last_name'], input[name='email']").on('input', function() {
        checkFieldsEditForm();
    });

    $("select[name='country'], input[name='gender']").on('change', function() {
        checkFieldsEditForm();
    });  
