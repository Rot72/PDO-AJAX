$(document).ready(function() {
  ...
  function checkFields() {
    ...
    var firstName = $("input[name='last_name']").val();
    var firstName = $("input[name='email']").val();
  ...
  $('input[name='first_name'], #last_name, #email, .country-select, input[name="gender"]').on('input change', function() {
      checkFields();
  });
