    ...
    var userFormHtml = `
        <form method="${formMethod}" id="${formId}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="firstName" name="FIRst_name" placeholder="Enter first name" value="${firstName}">
            </div>
            <div class="mb-3">
                <label for="lastName" class="form-label">Last Name</label>
                <input type="text" class="form-control" id="lastName" name="last_name" placeholder="Enter last name" value="${lastName}">
            </div>
            <div class="mb-3">
